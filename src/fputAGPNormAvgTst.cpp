...
int main(int argc, char *argv[])
{
    ...
    file << "Time" << "," << "AGPnorm" << "," << "Energy" << "," << "Entropy" << "," << "dHInt";
    ...
    Vector dHIntArr(int(tmax/deltaT));
    ...
    for (int average = 0; average < averages; average++)
    {
        ...
        for (int i = 0; i < int(tmax/deltaT); i++)
        {
            ...
            if (i % iStep == 0)
            {
                ...
                dHIntArr(i) = dHIntArr(i) + dHInt/averages;
    ...
    {
        file << "\n" << timeArray(i) << "," << AGPnorm(i) << "," << En(i) << "," << Entropy(i) << "," << dHIntArr(i);
    }
